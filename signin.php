...
?>
    ...
    <form action="" method="post">
		...
		<div class="text-center">Dont't have an account? <a href="signup.php">Signup here</a>
		<br>
		<a href="../order/index.php">Admin login</a>
		<br>
				<a href="forgotpassword.php">Fogot Password?</a>
